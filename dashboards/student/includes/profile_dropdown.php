<?php
/**
 * Student Profile Dropdown Component
 * Google-style profile dropdown with notifications
 */

// Get current student data if not already fetched
if (!isset($student)) {
    $db_header = new Database();
    $conn_header = $db_header->getConnection();
    
    $query_header = "SELECT s.*, u.email, u.username, u.profile_picture, u.status 
                     FROM students s 
                     JOIN users u ON s.user_id = u.user_id 
                     WHERE s.student_id = :student_id";
    $stmt_header = $conn_header->prepare($query_header);
    $stmt_header->bindParam(':student_id', $_SESSION['student_id']);
    $stmt_header->execute();
    $student = $stmt_header->fetch(PDO::FETCH_ASSOC);
}
...
$header_default_avatar = "data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24'%3E%3Ccircle cx='12' cy='8' r='4' fill='%233b82f6'/%3E%3Cpath d='M12 14c-4 0-7 2-7 4v2h14v-2c0-2-3-4-7-4z' fill='%233b82f6'/%3E%3C/svg%3E";
?>
    ...
    <div class="profile-dropdown" id="profileDropdown">
        ...
        <div class="profile-dropdown-header">
            ...
            <div class="profile-dropdown-info">
                <span class="profile-dropdown-name"><?php echo htmlspecialchars(($student['first_name'] ?? '') . ' ' . ($student['last_name'] ?? '')); ?></span>
        ...
        <div class="profile-dropdown-section">
            ...
            <a href="qr-code.php" class="profile-dropdown-item">
                <i class="fas fa-qrcode"></i>
                <span>My QR Code</span>
            </a>
            <a href="face-registration.php" class="profile-dropdown-item">
